...
![Группы безопасности](../img/7.3-secgroup.jpg)
------
...
- Решение
1. [count-vm.tf](7.3-terraform/src/count-vm.tf)
2. [for_each-vm.tf](7.3-terraform/src/for_each-vm.tf)
3. depends_on добавил в for_each-vm.tf
4. [locals.tf](7.3-terraform/src/locals.tf)
5. Инициализируйте проект [](7.3-terraform/src/netology)
------
...
Решение:
 - ![диски](../img/7.3-disk-count.jpg)
 - добавил группу безопасности [node01.tf](7.3-terraform/src/node01.tf)
 - добавил потом ее всем
------
