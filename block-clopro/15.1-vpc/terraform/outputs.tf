output "internal_ip_address_nat_vm" {
  value = yandex_compute_instance.instance_nat-vm[*].network_interface.0.ip_address
}

output "external_ip_address_nat_vm" {
  value = yandex_compute_instance.instance_nat-vm[*].network_interface.0.nat_ip_address
}
